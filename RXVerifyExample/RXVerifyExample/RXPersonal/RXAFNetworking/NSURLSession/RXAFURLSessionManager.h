...
#import "RXAFCompatibilityMacros.h"
NS_ASSUME_NONNULL_BEGIN
@interface RXAFURLSessionManager : NSObject
 ...
 */
@property (nonatomic, strong) id <RXAFURLResponseSerialization> responseSerializer;
 ...
 */
@property (readwrite, nonatomic, strong) RXAFNetworkReachabilityManager *reachabilityManager;
#endif
 ...
 */
- (void)setDidFinishEventsForBackgroundURLSessionBlock:(nullable void (^)(NSURLSession *session))block RXAF_API_UNAVAILABLE(macos);
